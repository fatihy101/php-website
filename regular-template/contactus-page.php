            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"><img src="images/post-horizontal-img-1.jpg" class="img-responsive"
                                alt="Wedding Magazine Website Template"></a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"><img src="images/post-horizontal-img-4.jpg" class="img-responsive"
                                alt="Wedding Magazine Website Template"></a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"> <img src="images/post-horizontal-img-2.jpg" class="img-responsive"
                                alt="Wedding Magazine Website Template"></a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"> <img src="images/post-horizontal-img-3.jpg" class="img-responsive"
                                alt="Wedding Magazine Website Template"></a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"><img src="images/post-horizontal-img-5.jpg" class="img-responsive"
                                alt="Wedding Magazine Website Template"></a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 nopadding">
                        <a href="#"><img src="images/post-horizontal-img-4.jpg" class="img-responsive"
        ...
        <div class="tiny-footer">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <p class="text-link text-right"><a href="#">Advertising</a> | <a href="#">Terms &amp;
