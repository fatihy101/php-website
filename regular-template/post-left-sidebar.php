        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <div class="page-section">
                    <h1 class="page-title">Post Left Sidebar Page</h1></div>
            </div>
        </div>
    </div>
    <div class="content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <h1>20+ Wedding Venue for Your Wedding Date in 2017</h1>
                            ...
                            <div class="post-img"> <img src="images/post-single.jpg" alt=""></div>
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    <div class="post-content">
                                        ...
                                        <blockquote>Eros pretium nam magna ne diam commodo viverra eget et leo curabitur a diam semper e tempor odio sed vehicula ornare libero viva acsod orna libero unc laoreet turpis elit non eleifend eget.</blockquote>
                                        ...
                                        <ul class="bullet bullet-check-circle listnone">
                                            <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                                            <li>Vestibulum nec metus quis magna scelerisque placerat.</li>
                                            <li>Cras rhoncus purus vel sapien volutpat tristique.</li>
                                            <li>Curabitur nec magna condimentum, consequat dui sed, mattis diam.</li>
                                            <li>Morbi dapibus neque a pharetra sodales.</li>
                                            <li>Donec commodo nisi ac massa dictum, eu dignissim odio condimentum.</li>
                                        </ul>
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        <form class="reply-form">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label class="control-label" for="e-mail">E-mail<span>*</span></label>
                                                        <input id="e-mail" name="e-mail" type="text" placeholder="E-mail" class="form-control input-md" required>
                                                    </div>
                                                </div>
                                                <!-- Text input-->
                                                <div class="col-md-8">
