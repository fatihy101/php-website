       ...
       <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="https://www.modernwedding.com.au/wp-content/uploads/2020/07/28/Anna-Wang.jpg" alt="..." style="height:600px; width:1400px;">
          </div>
          <div class="item">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4 col-md-6 col-xs-12">
                    <div class="post-vertical-block">
                        ...
                        <div class="post-vertical-content">
                            <h2><a href="#" class="post-title">Best 20+ Real Wedding Couple Inspiration for 2017</a></h2>
                            <p class="meta"><span class="meta-category"><a href="#" class="meta-link">Destinations</a></span> <span class="meta-date">19 Jan, 2017</span> <span class="meta-comments">(23) <a href="#" class="meta-link">Comments</a></span>
                            </p>
...
for Wedding in 2017</a></h2>
                            <p class="meta"><span class="meta-category"><a href="#" class="meta-link">real weddings</a></span> <span class="meta-date">19 Jan, 2017</span> <span class="meta-comments">(23) <a href="#" class="meta-link">Comments</a></span>
                            </p>
                 ...
                 <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                            <div class="realwedding-block">
                                ...
                                <div class="realwedding-content">
                                    ...
                                    <p>Molestie viverra id a massa pellentesque tellus urna donec at dolor simple dummy content.</p>
                                </div>
                            </div>
                            <!-- /.realwedding-block -->
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4 col-md-6 col-xs-12">
                    <div class="post-vertical-block">
                        ...
                        <div class="post-vertical-content">
                            <h2><a href="#" class="post-title">Are You Just Engaged Tip for Wedding in 2017</a></h2>
                            <p class="meta"><span class="meta-category"><a href="#" class="meta-link">fashion</a></span> <span class="meta-date">19 Jan, 2017</span> <span class="meta-comments">(23) <a href="#" class="meta-link">Comments</a></span>
                            </p>
                            <p>Rhoncus sed eros ipsum consequt act orci semper interdum elit.</p>
                            <a href="#" class="btn-link">Read More..</a>
                        </div>
