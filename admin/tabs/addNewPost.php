...
<iframe width="0" height="0" border="0" name="dummyframe" id="dummyframe" hidden></iframe>
  ...
  <div class="container">
        ...
        <form id ="articleForm" method="POST" action = "newPostDB.php" target="dummyframe" enctype="multipart/form-data">
            <div class="col-md-6">
            ...
            <div class="col-md-3 mt-2">
                <button name="publish" class="btn white-text theme-color">Yayınla</button>
            </div>
