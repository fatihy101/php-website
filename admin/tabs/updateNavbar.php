...
$SQL = "SELECT * FROM HeaderElements";
...
<div
    ...
    <h2 class="col h3">Navigasyon Çubuğunu Güncelle</h2>
</div>
    ...
    <table class="table table-borderless mb-5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="text" class="header-element-text form-control ml-n3 " placeholder="Başlık giriniz..."
                        data-field="<?php echo $result["id"]; ?>" value="<?php echo $result["text"];?>"></td>
                <td><input class="form-check-input ml-2" name="visibility" type="checkbox"
                        value="<?php echo $result["id"];?>" id="defaultCheck1" style="width: 20px; height: 20px;"
